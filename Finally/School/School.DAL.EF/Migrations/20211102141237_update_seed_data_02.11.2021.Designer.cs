...
namespace School.DAL.EF.Migrations
{
    ...
    [Migration("20211102141237_update_seed_data_02.11.2021")]
    partial class update_seed_data_02112021
    {
            ...
            modelBuilder.Entity("School.Core.Models.Course", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 2,
                            Description = "Курс поможет с нуля освоить востребованную специальность Java-разработчика. 	Программа построена таким образом, что вы не просто познакомитесь с основами Java и объектно-ориентированным программированием на нем, 	научитесь разбираться в типах данных, использовать алгоритмы и коллекции Java. ",
                            DurationWeeks = 8,
                            Level = 0,
                            Price = 1420.0,
                        ...
                        {
                            Id = 3,
                            Description = "Современный дизайн — обширная область, которая тесно соприкасается с ИТ-сферой, а UX/UI-дизайнеры, веб-дизайнеры и дизайнеры интерфейсов — одновременно и художники, и технически подкованные специалисты, востребованные в индустрии.\n	Курс поможет с нуля освоить востребованную специальность Design-разработчика",
                            DurationWeeks = 6,
                            Level = 0,
                            Price = 1250.0,
                        ...
                        {
                            Id = 11,
                            Description = "IT-HR — это специалист, деятельность которого объединяет IT-рекрутинг и HR-менеджмент.IT-HR работает с коллективом компании, развивает корпоративную культуру, помогает адаптироваться новым коллегам.\n	Основная задача HR-менеджера — сопровождение сотрудника на протяжении всего времени его работы в компании.",
                            DurationWeeks = 5,
                            Level = 1,
                            Price = 1570.0,
            ...
            modelBuilder.Entity("School.Core.Models.Group", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            StartDate = new DateTime(2021, 11, 2, 0, 0, 0, 0, DateTimeKind.Local),
                            Status = 0,
                            TeacherId = 1,
                            Title = "C#Group"
                        },
                        ...
                        new
                        {
                            ...
                            Status = 1,
                            TeacherId = 4,
                            Title = "Промышленная разработка ПО на ASP.NETGroup"
                        },
                        new
                        {
                            Id = 5,
                            ...
                            Status = 0,
                            TeacherId = 5,
                            Title = "Промышленная разработка ПО на JavaGroup"
                        });
                });
