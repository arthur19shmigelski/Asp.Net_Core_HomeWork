...
namespace School.DAL.EF.Migrations
{
    ...
    [Migration("20211105191632_update_seed_3")]
            ...
            modelBuilder.Entity("School.Core.Models.Group", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            StartDate = new DateTime(2021, 11, 5, 0, 0, 0, 0, DateTimeKind.Local),
                            Status = 0,
                            TeacherId = 1,
                            Title = "C# Group"
                        },
                        ...
                        new
                        {
                            ...
                            Status = 0,
                            TeacherId = 4,
                            Title = "Промышленная разработка ПО на ASP.NET Group"
                        },
                        new
                        {
                            Id = 5,
                            ...
                            Status = 0,
                            TeacherId = 5,
                            Title = "Промышленная разработка ПО на Java Group"
                        });
                });
